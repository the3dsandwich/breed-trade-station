...
try {
  ...
  console.log('Opening native game');
  await launch();
  ...
  console.log('Waiting for the normal autosave');
  ...
  console.log('Selecting parents with desktop clicks');
  ...
  console.log('Release passed; closing native window');
  ...
  session = undefined;
  console.log('Reopening native game');
  await launch();
